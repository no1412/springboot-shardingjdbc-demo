package com.m.springbootshardingjdbcdemo.config;

import com.github.xiaoymin.knife4j.spring.extension.OpenApiExtensionResolver;
import com.m.springbootshardingjdbcdemo.constants.ResponseStatus;
...
public class OpenApiConfig {
    ...
    private List<RequestParameter> getGlobalRequestParameters() {
        ...
        parameters.add(new RequestParameterBuilder()
                .name("AppKey")
                .description("springboot shardingjdbc demo App Key")
                .required(false)
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("xxxx", "http://xxxxxx.com", "xxxx@mail.com"))
